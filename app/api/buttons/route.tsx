...
import { BUTTON_RX, SocialButtonDef, SOCIAL_BUTTONS, BUTTON_WIDTH, BUTTON_HEIGHT, BUTTON_MIN_WIDTH, BUTTON_FILL, BUTTON_LABEL_COLOR } from "@/lib/social-button";

// ─── social button component ────────────────────────────────────────────────────   

function SocialButton({ button }: { button: SocialButtonDef }) {
    return (
        <div
            style={{
                background: BUTTON_FILL,
                borderRadius: BUTTON_RX,
                fontSize: 12,
                position: "relative",
                overflow: "hidden",
        ...
        >
            {button.animation === "shimmer" && <ShimmerLayer />}
    ...
    >
      <defs>
        <linearGradient id="shimmer-grad" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="rgb(63, 185, 80)" stopOpacity={0} />
          <stop offset="50%" stopColor="rgb(63, 185, 80)" stopOpacity={0.2} />
          <stop offset="100%" stopColor="rgb(63, 185, 80)" stopOpacity={0} />
        </linearGradient>
      </defs>
      <g>
        <animateTransform
...
export async function GET(request: Request) {
    ...
    // const loopWidth = techs.length * ITEM_WIDTH;
